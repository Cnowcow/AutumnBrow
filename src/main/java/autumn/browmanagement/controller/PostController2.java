...
import autumn.browmanagement.service.PostService2;
...
public class PostController2 {
    ...
    // 시술내역 등록 폼
    @GetMapping("/post/create2")
    public String createForm(Model model){

        List<Treatment2> treatments = treatmentService.findParentTreatments(); // 모든 시술 조회
        model.addAttribute("treatments", treatments);

        List<Visit> visits = visitService.visitList(); // 모든 방문 경로 조회
        model.addAttribute("visits", visits);

        return "post/postCreateForm2";
    }


    // 시술내역 등록 요청
    @PostMapping("/post/create2")
    public String createPost(@ModelAttribute PostDTO postDTO, Model model) {
        System.out.println("11111111111 = " + postDTO.getParentTreatment());
        System.out.println("22222222222 = " + postDTO.getDirectParentTreatment());
        System.out.println("33333333333 = " + postDTO.getChildTreatment());
        System.out.println("44444444444 = " + postDTO.getDirectChildTreatment());

        try {
            // 서비스에 파일 처리 및 업로드 요청
            postService2.handleFileUpload(postDTO);
            postService2.createPost(postDTO); // Post 생성
    ...
    // 시술내역 삭제 요청
    @PostMapping("/post/{postId}/delete2")
    ...
    // 시술내역 수정 페이지
    @GetMapping("/post/{postId}/update2")
    ...
    // 시술내역 수정 요청
    @PostMapping("/post/{postId}/update2")
...
*/
    ...
    */
    ...
    // 관리자용 시술내역 조회
    @GetMapping("/post/{userId}/userList2")
...
*/
    ...
    // 사용자별 시술내역 조회
    @GetMapping("/post/{userId}/ownList2")
